...
<!--代办人-->
<div class="agency">
    <form class="form-horizontal" action="/AddAgencyServlet">
        <div class="form-group">
            <label for="inputText1" class="col-sm-2 control-label">编号</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name="ano" id="inputText1" placeholder="请输入编号">
            </div>
        </div>
        <div class="form-group">
            <label for="inputText2" class="col-sm-2 control-label">姓名</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name="aname" id="inputText2" placeholder="请输入姓名">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="aphone" id="inputText3" placeholder="请输入电话">
            </div>
        </div>
        <div class="form-group">
            <label for="inputText4" class="col-sm-2 control-label">备注</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name="aremark" id="inputText4" placeholder="请输入备注">
            </div>
        </div>
        <div class="form-group">
