    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li><a href="/FindAgencyByPageServlet">经办人信息</a></li>
                <li><a href="/FindClientByPageServlet">顾客信息</a></li>
                <li><a href="/FindMedicineByPageServlet">药品信息</a></li>
            </ul>
    ...
    <div class="agency">
        ...
        <div class="table-responsive">
            <div style="float: left"><!--左浮动-->
                <form class="form-inline" action="/FindAgencyByPageServlet">
            ...
            <form action="/DeleteSelectedAgencyServlet">
                <div style="float: right;margin: 5px"><!--右浮动-->
                    <a class="btn btn-info" href="/addAgency.jsp" role="button">添加经办人</a>
                ...
                <table class="table table-hover table-bordered ">
                    ...
                    <c:forEach items="${agencyPage.list}" var="agency">
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-info" href="/FindAgencyByAnoServlet?ano=${agency.ano}" role="button">修改</a>
                                <a class="btn btn-info" href="/DeleteAgencyServlet?ano=${agency.ano}" role="button">删除</a>
                            </td>
                        </tr>
                    </c:forEach>
                </table>
...
<div class="agency">
    ...
    <div class="table-responsive">
        ...
        <form action="/DeleteSelectedLoginServlet">
            <div style="float: right;margin: 5px"><!--右浮动-->
                <a class="btn btn-info" href="/addUser.jsp" role="button">添加用户</a>
                <button type="submit" class="btn btn-info">删除选中</button>
            </div>
            <table class="table table-hover table-bordered ">
                <tr>
                ...
                <c:forEach items="${loginPage.list}" var="login">
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-info" href="/FindLoginByUsernameServlet?username=${login.username}" role="button">修改</a>
                            <a class="btn btn-info" href="/DeleteLoginServlet?username=${login.username}" role="button">删除</a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
...
<c:if test="${id == 3}">
    <div class="agency">
        ...
        <div class="table-responsive">
            ...
            <form action="/DeleteSelectedClientServlet">
                <div style="float: right;margin: 5px"><!--右浮动-->
                    <a class="btn btn-info" href="/addClient.jsp" role="button">添加顾客</a>
                    <button type="submit" class="btn btn-info">删除选中</button>
                </div>
                <table class="table table-hover table-bordered ">
                    <tr>
                    ...
                    <c:forEach items="${clientPage.list}" var="client">
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-info" href="/FindClientByCnoServlet?cno=${client.cno}" role="button">修改</a>
                                <a class="btn btn-info" href="/DeleteClientServlet?cno=${client.cno}" role="button">删除</a>
                            </td>
                        </tr>
                    </c:forEach>
                </table>
...
<c:if test="${id == 4}">
    <div class="agency">
        ...
        <div class="table-responsive">
            ...
            <form action="/DeleteSelectedMedicineServlet">
                <div style="float: right;margin: 5px"><!--右浮动-->
                ...
                <table class="table table-hover table-bordered ">
                    ...
                    <c:forEach items="${medicinePage.list}" var="medicine">
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-info" href="/FindMedicineByMnoServlet?ano=${medicine.mno}" role="button">修改</a>
                                <a class="btn btn-info" href="/DeleteMedicineServlet?ano=${medicine.mno}" role="button">删除</a>
                            </td>
                        </tr>
                    </c:forEach>
                </table>
