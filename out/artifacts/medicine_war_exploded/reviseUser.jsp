...
<!--用户-->
<div class="agency">
    <form class="form-horizontal" action="/ReviseLoginServlet">
        <div class="form-group">
            <label for="inputText1" class="col-sm-2 control-label">用户名</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name="username" value="${login.username}" id="inputText1" placeholder="请输入用户名">
            </div>
        </div>
        <div class="form-group">
            <label for="inputText2" class="col-sm-2 control-label">密码</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name="password" value="${login.password}" id="inputText2" placeholder="请输入密码">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <div class="radio">
                    <label>
                        <input type="radio" name="usertype" id="optionsRadios2" value="普通用户" checked>
                        普通用户
                    </label>
                </div>
            </div>
